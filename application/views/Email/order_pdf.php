...
.style_block b {
    ...
    <body style="margin: 0;
        ...
        <div class="" style="padding:50px 0px">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024" style="background: #000;padding: 0 20px">
                <tr>
            ...
            <table class="carttable"  border-color= "#9E9E9E" align="center" border="1" cellpadding="0" cellspacing="0" width="1024" style="background: #fff;padding:20px">
