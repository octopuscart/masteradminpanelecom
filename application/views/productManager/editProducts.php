                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="final_price form-control" id='finalprice'><?php echo (($product_obj->price | 0)); ?></span>
                                            <input type="hidden" class="form-control price_tag_text" id='finalprice1' name="price" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" value="<?php echo (($product_obj->price | 0)); ?>"> 
                                        </div>
